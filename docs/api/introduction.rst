...
A graph :math:`G(V,E)` contains vertices and edges. In |Bindings| both the vertices and the edges of 
...
.. note::
   ...
   While in the |Bindings| vertices and edges are always integers, this restriction does not exist in the 
   backend |Project|. 
