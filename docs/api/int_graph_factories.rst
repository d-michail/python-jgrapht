...
The main factory function which creates graphs is :py:meth:`jgrapht.create_int_graph`. 
...
.. autofunction:: jgrapht.create_int_graph
...
.. autofunction:: jgrapht.create_int_dag
...
.. autofunction:: jgrapht.create_sparse_int_graph

A helper function :py:meth:`jgrapht.as_sparse_int_graph` can help in order to create a sparse
graph from another graph. 

.. autofunction:: jgrapht.as_sparse_int_graph
