...
int jgrapht_rz_attributes_store_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY, int);
int jgrapht_ri_attributes_store_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY, int);
int jgrapht_rl_attributes_store_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY, long long int);
int jgrapht_rd_attributes_store_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY, double);
int jgrapht_rs_attributes_store_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY, char* BYTEARRAY);
...
int jgrapht_rx_attributes_store_remove(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY);
...
int jgrapht_executor_thread_pool_create(int, void** OUTPUT);
int jgrapht_executor_thread_pool_shutdown(void *, long long int);
...
int jgrapht_rx_export_string_dimacs(void *, dimacs_format_t, int, void*, void** OUTPUT);
...
int jgrapht_rr_equivalentflowtree_tree(void *, void* LONG_TO_FPTR, void* LONG_TO_FPTR, void *, void** OUTPUT);
...
int jgrapht_rr_graph_dag_create(int, int, void* LONG_TO_FPTR, void* LONG_TO_FPTR, void*, void **OUTPUT);
...
int jgrapht_rx_graph_dag_vertex_descendants(void *, void *LONG_TO_PTR, void** OUTPUT);
...
int jgrapht_rx_graph_dag_vertex_ancestors(void *, void *LONG_TO_PTR, void** OUTPUT);
...
int jgrapht_xxrr_graph_attrs_get(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_ixrr_graph_attrs_vertex_get(void *, int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_lxrr_graph_attrs_vertex_get(void *, long long int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_rxrr_graph_attrs_vertex_get(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xirr_graph_attrs_edge_get(void *, int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xlrr_graph_attrs_edge_get(void *, long long int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xrrr_graph_attrs_edge_get(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xxrr_graph_attrs_put(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void**OUTPUT);
int jgrapht_ixrr_graph_attrs_vertex_put(void *, int, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_lxrr_graph_attrs_vertex_put(void *, long long int, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_rxrr_graph_attrs_vertex_put(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xirr_graph_attrs_edge_put(void *, int, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xlrr_graph_attrs_edge_put(void *, long long int, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xrrr_graph_attrs_edge_put(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xxrr_graph_attrs_remove(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_ixrr_graph_attrs_vertex_remove(void *, int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_lxrr_graph_attrs_vertex_remove(void *, long long int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_rxrr_graph_attrs_vertex_remove(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xirr_graph_attrs_edge_remove(void *, int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xlrr_graph_attrs_edge_remove(void *, long long int, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xrrr_graph_attrs_edge_remove(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xxrr_graph_attrs_contains(void *, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_ixrr_graph_attrs_vertex_contains(void *, int, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_lxrr_graph_attrs_vertex_contains(void *, long long int, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_rxrr_graph_attrs_vertex_contains(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_xirr_graph_attrs_edge_contains(void *, int, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_xlrr_graph_attrs_edge_contains(void *, long long int, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_xrrr_graph_attrs_edge_contains(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_xxrx_graph_attrs_keys_iterator(void *, void** OUTPUT);
int jgrapht_ixrx_graph_attrs_vertex_keys_iterator(void *, int, void** OUTPUT);
int jgrapht_lxrx_graph_attrs_vertex_keys_iterator(void *, long long int, void** OUTPUT);
int jgrapht_rxrx_graph_attrs_vertex_keys_iterator(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xirx_graph_attrs_edge_keys_iterator(void *, int, void** OUTPUT);
int jgrapht_xlrx_graph_attrs_edge_keys_iterator(void *, long long int, void** OUTPUT);
int jgrapht_xrrx_graph_attrs_edge_keys_iterator(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xxxx_graph_attrs_size(void *, int* OUTPUT);
int jgrapht_ixxx_graph_attrs_vertex_size(void *, int, int* OUTPUT);
int jgrapht_lxxx_graph_attrs_vertex_size(void *, long long int, int* OUTPUT);
int jgrapht_rxxx_graph_attrs_vertex_size(void *, void *LONG_TO_PTR, int* OUTPUT);
...
int jgrapht_handles_put_ref(void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_handles_put2_ref(void *LONG_TO_PTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void** OUTPUT);
int jgrapht_handles_get_ref(void *, void** OUTPUT, void** OUTPUT, void** OUTPUT);
...
int jgrapht_rr_import_string_gml(void *, char* BYTEARRAY, void* LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_file_json(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_string_json(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_file_csv(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, csv_format_t, int, int, int);
...
int jgrapht_rr_import_string_csv(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, csv_format_t, int, int, int);
int jgrapht_ii_import_file_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_file_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_file_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ii_import_string_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_string_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_string_gexf(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ii_import_file_graphml_simple(void *, char* BYTEARRAY, void * LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_file_graphml_simple(void *, char* BYTEARRAY, void * LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_file_graphml_simple(void *, char* BYTEARRAY, void * LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ii_import_string_graphml_simple(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_string_graphml_simple(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_string_graphml_simple(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ii_import_file_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_file_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_file_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ii_import_string_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_ll_import_string_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
int jgrapht_rr_import_string_graphml(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR, int);
...
int jgrapht_rr_import_file_dot(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_string_dot(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_file_graph6sparse6(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_rr_import_string_graph6sparse6(void *, char* BYTEARRAY, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void *LONG_TO_FPTR, void* LONG_TO_FPTR, void* LONG_TO_FPTR);
...
int jgrapht_xx_map_create(void** OUTPUT);
int jgrapht_xx_map_linked_create(void** OUTPUT);
int jgrapht_xx_map_keys_it_create(void *, void** OUTPUT);
int jgrapht_xx_map_size(void *, int* OUTPUT);
int jgrapht_xx_map_values_it_create(void *, void** OUTPUT);
int jgrapht_id_map_put(void *, int, double);
int jgrapht_ii_map_put(void *, int, int);
int jgrapht_is_map_put(void *, int, char* BYTEARRAY);
int jgrapht_ix_map_put(void *, int, void *);
int jgrapht_ir_map_put(void *, int, void *LONG_TO_PTR, void *);
int jgrapht_ld_map_put(void *, long long int, double);
int jgrapht_li_map_put(void *, long long int, int);
int jgrapht_ls_map_put(void *, long long int, char* BYTEARRAY);
int jgrapht_lx_map_put(void *, long long int, void *);
int jgrapht_lr_map_put(void *, long long int, void *LONG_TO_PTR, void *);
int jgrapht_rd_map_put(void *, void *LONG_TO_PTR, void *, double);
int jgrapht_ri_map_put(void *, void *LONG_TO_PTR, void *, int);
int jgrapht_rs_map_put(void *, void *LONG_TO_PTR, void *, char* BYTEARRAY);
int jgrapht_rx_map_put(void *, void *LONG_TO_PTR, void *, void *);
int jgrapht_rr_map_put(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, void *);
int jgrapht_id_map_get(void *, int, double* OUTPUT);
int jgrapht_ii_map_get(void *, int, int* OUTPUT);
int jgrapht_is_map_get(void *, int, void** OUTPUT);
int jgrapht_ix_map_get(void *, int, void** OUTPUT);
int jgrapht_ir_map_get(void *, int, void** OUTPUT);
int jgrapht_ld_map_get(void *, long long int, double* OUTPUT);
int jgrapht_li_map_get(void *, long long int, int* OUTPUT);
int jgrapht_ls_map_get(void *, long long int, void** OUTPUT);
int jgrapht_lx_map_get(void *, long long int, void** OUTPUT);
int jgrapht_lr_map_get(void *, long long int, void** OUTPUT);
int jgrapht_rd_map_get(void *, void *LONG_TO_PTR, void *, double* OUTPUT);
int jgrapht_ri_map_get(void *, void *LONG_TO_PTR, void *, int* OUTPUT);
int jgrapht_rs_map_get(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_rx_map_get(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_rr_map_get(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_ix_map_contains_key(void *, int, int* OUTPUT);
int jgrapht_lx_map_contains_key(void *, long long int, int* OUTPUT);
int jgrapht_rx_map_contains_key(void *, void *LONG_TO_PTR, void *, int* OUTPUT);
int jgrapht_id_map_remove(void *, int, double* OUTPUT);
int jgrapht_ii_map_remove(void *, int, int* OUTPUT);
int jgrapht_is_map_remove(void *, int, void** OUTPUT);
int jgrapht_ix_map_remove(void *, int, void** OUTPUT);
int jgrapht_ir_map_remove(void *, int, void** OUTPUT);
int jgrapht_ld_map_remove(void *, long long int, double* OUTPUT);
int jgrapht_li_map_remove(void *, long long int, int* OUTPUT);
int jgrapht_ls_map_remove(void *, long long int, void** OUTPUT);
int jgrapht_lx_map_remove(void *, long long int, void** OUTPUT);
int jgrapht_lr_map_remove(void *, long long int, void** OUTPUT);
int jgrapht_rd_map_remove(void *, void *LONG_TO_PTR, void *, double* OUTPUT);
int jgrapht_ri_map_remove(void *, void *LONG_TO_PTR, void *, int* OUTPUT);
int jgrapht_rs_map_remove(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_rx_map_remove(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
int jgrapht_rr_map_remove(void *, void *LONG_TO_PTR, void *, void** OUTPUT);
...
int jgrapht_rr_graph_vertex_get_ptr(void *, void *LONG_TO_PTR, void**OUTPUT);
int jgrapht_rr_graph_edge_get_ptr(void *, void *LONG_TO_PTR, void**OUTPUT);
...
int jgrapht_ix_sp_exec_delta_stepping_get_path_between_vertices(void *, int, int, double, void*, void** OUTPUT);
int jgrapht_lx_sp_exec_delta_stepping_get_path_between_vertices(void *, long long int, long long int, double, void*, void** OUTPUT);
int jgrapht_rx_sp_exec_delta_stepping_get_path_between_vertices(void *, void *LONG_TO_PTR, void *LONG_TO_PTR, double, void*, void** OUTPUT);
int jgrapht_ix_sp_exec_delta_stepping_get_singlesource_from_vertex(void *, int, double, void*, void** OUTPUT);
int jgrapht_lx_sp_exec_delta_stepping_get_singlesource_from_vertex(void *, long long int, double, void*, void** OUTPUT);
int jgrapht_rx_sp_exec_delta_stepping_get_singlesource_from_vertex(void *, void *LONG_TO_PTR, double, void*, void** OUTPUT);
...
int jgrapht_xx_sp_exec_contraction_hierarchy(void *, void *, long long int, void** OUTPUT);
...
int jgrapht_xx_sp_exec_transit_node_routing(void *, void *, void** OUTPUT);
