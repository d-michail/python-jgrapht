...
int jgrapht_xxl_graph_attrs_get(void *, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_ixl_graph_attrs_vertex_get(void *, int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_lxl_graph_attrs_vertex_get(void *, long long int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_rxl_graph_attrs_vertex_get(void *, void *LONG_TO_PTR, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_xil_graph_attrs_edge_get(void *, int, char* BYTEARRAY, long long* OUTPUT);
...
int jgrapht_xil_graph_attrs_edge_put(void *, int, char* BYTEARRAY, long long int);
int jgrapht_xll_graph_attrs_edge_put(void *, long long int, char* BYTEARRAY, long long int);
int jgrapht_xrl_graph_attrs_edge_put(void *, void *LONG_TO_PTR, char* BYTEARRAY, long long int);
int jgrapht_xxx_graph_attrs_remove(void *, char* BYTEARRAY);
int jgrapht_ixx_graph_attrs_vertex_remove(void *, int, char* BYTEARRAY);
int jgrapht_lxx_graph_attrs_vertex_remove(void *, long long int, char* BYTEARRAY);
int jgrapht_rxx_graph_attrs_vertex_remove(void *, void *LONG_TO_PTR, char* BYTEARRAY);
int jgrapht_xix_graph_attrs_edge_remove(void *, int, char* BYTEARRAY);
int jgrapht_xlx_graph_attrs_edge_remove(void *, long long int, char* BYTEARRAY);
int jgrapht_xrx_graph_attrs_edge_remove(void *, void *LONG_TO_PTR, char* BYTEARRAY);
int jgrapht_xxx_graph_attrs_contains(void *, char* BYTEARRAY, int* OUTPUT);
int jgrapht_ixx_graph_attrs_vertex_contains(void *, int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_lxx_graph_attrs_vertex_contains(void *, long long int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_rxx_graph_attrs_vertex_contains(void *, void *LONG_TO_PTR, char* BYTEARRAY, int* OUTPUT);
int jgrapht_xix_graph_attrs_edge_contains(void *, int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_xlx_graph_attrs_edge_contains(void *, long long int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_xrx_graph_attrs_edge_contains(void *, void *LONG_TO_PTR, char* BYTEARRAY, int* OUTPUT);
int jgrapht_xxx_graph_attrs_keys_iterator(void *, void** OUTPUT);
int jgrapht_ixx_graph_attrs_vertex_keys_iterator(void *, int, void** OUTPUT);
int jgrapht_lxx_graph_attrs_vertex_keys_iterator(void *, long long int, void** OUTPUT);
int jgrapht_rxx_graph_attrs_vertex_keys_iterator(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xix_graph_attrs_edge_keys_iterator(void *, int, void** OUTPUT);
int jgrapht_xlx_graph_attrs_edge_keys_iterator(void *, long long int, void** OUTPUT);
int jgrapht_xrx_graph_attrs_edge_keys_iterator(void *, void *LONG_TO_PTR, void** OUTPUT);
int jgrapht_xxx_graph_attrs_size(void *, int* OUTPUT);
int jgrapht_ixx_graph_attrs_vertex_size(void *, int, int* OUTPUT);
int jgrapht_lxx_graph_attrs_vertex_size(void *, long long int, int* OUTPUT);
int jgrapht_rxx_graph_attrs_vertex_size(void *, void *LONG_TO_PTR, int* OUTPUT);
int jgrapht_xix_graph_attrs_edge_size(void *, int, int* OUTPUT);
int jgrapht_xlx_graph_attrs_edge_size(void *, long long int, int* OUTPUT);
int jgrapht_xrx_graph_attrs_edge_size(void *, void *LONG_TO_PTR, int* OUTPUT);
