...
int jgrapht_ii_cut_gomoryhu_min_st_cut(void *, int, int, double* OUTPUT, void** OUTPUT);

int jgrapht_ll_cut_gomoryhu_min_st_cut(void *, long long int, long long int, double* OUTPUT, void** OUTPUT);

int jgrapht_xx_cut_gomoryhu_min_cut(void *, double* OUTPUT, void** OUTPUT);

int jgrapht_ii_cut_gomoryhu_tree(void *, void** OUTPUT);

int jgrapht_ll_cut_gomoryhu_tree(void *, void** OUTPUT);

int jgrapht_ll_cut_gomoryhu_tree_with_suppliers(void *, void* LONG_TO_FPTR, void* LONG_TO_FPTR, void** OUTPUT);
...
int jgrapht_ii_export_string_dimacs(void *, dimacs_format_t, int, void*, void** OUTPUT);

int jgrapht_ll_export_string_dimacs(void *, dimacs_format_t, int, void*, void** OUTPUT);
...
int jgrapht_ii_maxflow_exec_push_relabel(void *, int, int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ll_maxflow_exec_push_relabel(void *, long long int, long long int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ii_maxflow_exec_dinic(void *, int, int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ll_maxflow_exec_dinic(void *, long long int, long long int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ii_maxflow_exec_edmonds_karp(void *, int, int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ll_maxflow_exec_edmonds_karp(void *, long long int, long long int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ii_maxflow_exec_boykov_kolmogorov(void *, int, int, double* OUTPUT, void **OUTPUT, void **OUTPUT);

int jgrapht_ll_maxflow_exec_boykov_kolmogorov(void *, long long int, long long int, double* OUTPUT, void **OUTPUT, void **OUTPUT);

int jgrapht_ii_mincostflow_exec_capacity_scaling(void *, void *, void *, void *, int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_ll_mincostflow_exec_capacity_scaling(void *, void *, void *, void *, int, double* OUTPUT, void** OUTPUT, void** OUTPUT);

int jgrapht_xx_equivalentflowtree_exec_gusfield(void *, void** OUTPUT);

int jgrapht_ii_equivalentflowtree_max_st_flow(void *, int, int, double* OUTPUT);

int jgrapht_ll_equivalentflowtree_max_st_flow(void *, long long int, long long int, double* OUTPUT);

int jgrapht_ii_equivalentflowtree_tree(void *, void** OUTPUT);
...
int jgrapht_ll_graph_vertices_count(void *, long long* OUTPUT);

int jgrapht_ii_graph_edges_count(void *, int* OUTPUT);

int jgrapht_ll_graph_edges_count(void *, long long* OUTPUT);

int jgrapht_ii_graph_add_vertex(void *, int* OUTPUT);

int jgrapht_ll_graph_add_vertex(void *, long long* OUTPUT);

int jgrapht_ii_graph_add_given_vertex(void *, int, int *OUTPUT);

int jgrapht_ll_graph_add_given_vertex(void *, long long int, int *OUTPUT);

int jgrapht_ii_graph_remove_vertex(void *, int, int* OUTPUT);

int jgrapht_ll_graph_remove_vertex(void *, long long int, int* OUTPUT);

int jgrapht_ii_graph_contains_vertex(void *, int, int* OUTPUT);

int jgrapht_ll_graph_contains_vertex(void *, long long int, int* OUTPUT);
...
int jgrapht_ii_graph_remove_edge(void *, int, int* OUTPUT);

int jgrapht_ll_graph_remove_edge(void *, long long int, int* OUTPUT);

int jgrapht_ii_graph_contains_edge(void *, int, int* OUTPUT);

int jgrapht_ll_graph_contains_edge(void *, long long int, int* OUTPUT);

int jgrapht_ii_graph_contains_edge_between(void *, int, int, int* OUTPUT);

int jgrapht_ll_graph_contains_edge_between(void *, long long int, long long int, int* OUTPUT);

int jgrapht_ii_graph_degree_of(void *, int, int* OUTPUT);

int jgrapht_ll_graph_degree_of(void *, long long int, long long* OUTPUT);

int jgrapht_ii_graph_indegree_of(void *, int, int* OUTPUT);

int jgrapht_ll_graph_indegree_of(void *, long long int, long long* OUTPUT);

int jgrapht_ii_graph_outdegree_of(void *, int, int* OUTPUT);

int jgrapht_ll_graph_outdegree_of(void *, long long int, long long * OUTPUT);
...
int jgrapht_ii_graph_get_edge_weight(void *, int, double* OUTPUT);

int jgrapht_ll_graph_get_edge_weight(void *, long long int, double* OUTPUT);
...
int jgrapht_ii_graph_create_between_eit(void *, int, int, void** OUTPUT);

int jgrapht_ll_graph_create_between_eit(void *, long long int, long long int, void** OUTPUT);

int jgrapht_ii_graph_vertex_create_eit(void *, int, void** OUTPUT);

int jgrapht_ll_graph_vertex_create_eit(void *, long long int, void** OUTPUT);

int jgrapht_ii_graph_vertex_create_out_eit(void *, int, void** OUTPUT);

int jgrapht_ll_graph_vertex_create_out_eit(void *, long long int, void** OUTPUT);

int jgrapht_ii_graph_vertex_create_in_eit(void *, int, void** OUTPUT);

int jgrapht_ll_graph_vertex_create_in_eit(void *, long long int, void** OUTPUT);
...
int jgrapht_ii_graph_as_weighted(void *, void *LONG_TO_FPTR, int, int, void** OUTPUT);

int jgrapht_ll_graph_as_weighted(void *, void *LONG_TO_FPTR, int, int, void** OUTPUT);
...
int jgrapht_ii_graph_as_subgraph(void *, void *, void *, void** OUTPUT);

int jgrapht_ll_graph_as_subgraph(void *, void *, void *, void** OUTPUT);

int jgrapht_ii_graph_as_graph_union(void *, void *, void *LONG_TO_FPTR, void** OUTPUT);

int jgrapht_ll_graph_as_graph_union(void *, void *, void *LONG_TO_FPTR, void** OUTPUT);
...
int jgrapht_ll_graph_dag_vertex_descendants(void *, long long int, void** OUTPUT);

int jgrapht_ii_graph_dag_vertex_ancestors(void *, int, void** OUTPUT);

int jgrapht_ll_graph_dag_vertex_ancestors(void *, long long int, void** OUTPUT);
...
int jgrapht_ii_graph_attrs_vertex_get_long(void *, int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_ll_graph_attrs_vertex_get_long(void *, long long int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_ii_graph_attrs_edge_get_long(void *, int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_ll_graph_attrs_edge_get_long(void *, long long int, char* BYTEARRAY, long long* OUTPUT);
int jgrapht_xx_graph_attrs_put_long(void *, char* BYTEARRAY, long long int);
int jgrapht_ii_graph_attrs_vertex_put_long(void *, int, char* BYTEARRAY, long long int);
int jgrapht_ll_graph_attrs_vertex_put_long(void *, long long int, char* BYTEARRAY, long long int);
int jgrapht_ii_graph_attrs_edge_put_long(void *, int, char* BYTEARRAY, long long int);
int jgrapht_ll_graph_attrs_edge_put_long(void *, long long int, char* BYTEARRAY, long long int);
int jgrapht_xx_graph_attrs_remove(void *, char* BYTEARRAY);
int jgrapht_ii_graph_attrs_vertex_remove(void *, int, char* BYTEARRAY);
int jgrapht_ll_graph_attrs_vertex_remove(void *, long long int, char* BYTEARRAY);
int jgrapht_ii_graph_attrs_edge_remove(void *, int, char* BYTEARRAY);
int jgrapht_ll_graph_attrs_edge_remove(void *, long long int, char* BYTEARRAY);
int jgrapht_xx_graph_attrs_contains(void *, char* BYTEARRAY, int* OUTPUT);
int jgrapht_ii_graph_attrs_vertex_contains(void *, int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_ll_graph_attrs_vertex_contains(void *, long long int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_ii_graph_attrs_edge_contains(void *, int, char* BYTEARRAY, int* OUTPUT);
int jgrapht_ll_graph_attrs_edge_contains(void *, long long int, char* BYTEARRAY, int* OUTPUT);
...
int jgrapht_ii_link_prediction_exec_adamic_adar_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_adamic_adar_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_common_neighbors(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_common_neighbors(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_hub_depressed_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_hub_depressed_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_hub_promoted_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_hub_promoted_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_jaccard_coefficient(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_jaccard_coefficient(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_leicht_holme_newman_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_leicht_holme_newman_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_preferential_attachment(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_preferential_attachment(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_resource_allocation_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_resource_allocation_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_salton_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_salton_index(void *, long long int, long long int, double* OUTPUT);
int jgrapht_ii_link_prediction_exec_sorensen_index(void *, int, int, double* OUTPUT);
int jgrapht_ll_link_prediction_exec_sorensen_index(void *, long long int, long long int, double* OUTPUT);
...
int jgrapht_ii_scoring_exec_custom_katz_centrality(void *, double, void *LONG_TO_FPTR, int, double, void** OUTPUT);
int jgrapht_ll_scoring_exec_custom_katz_centrality(void *, double, void *LONG_TO_FPTR, int, double, void** OUTPUT);
...
int jgrapht_ii_sp_exec_dijkstra_get_path_between_vertices(void *, int, int, void** OUTPUT);

int jgrapht_ll_sp_exec_dijkstra_get_path_between_vertices(void *, long long int, long long int, void** OUTPUT);

int jgrapht_ii_sp_exec_bidirectional_dijkstra_get_path_between_vertices(void *, int, int, void** OUTPUT);

int jgrapht_ll_sp_exec_bidirectional_dijkstra_get_path_between_vertices(void *, long long int, long long int, void** OUTPUT);

int jgrapht_ii_sp_exec_dijkstra_get_singlesource_from_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_sp_exec_dijkstra_get_singlesource_from_vertex(void *, long long int, void** OUTPUT);

int jgrapht_ii_sp_exec_bellmanford_get_singlesource_from_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_sp_exec_bellmanford_get_singlesource_from_vertex(void *, long long int, void** OUTPUT);

int jgrapht_ii_sp_exec_bfs_get_singlesource_from_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_sp_exec_bfs_get_singlesource_from_vertex(void *, long long int, void** OUTPUT);
...
int jgrapht_ii_sp_singlesource_get_path_to_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_sp_singlesource_get_path_to_vertex(void *, long long int, void** OUTPUT);

int jgrapht_ii_sp_allpairs_get_path_between_vertices(void *, int, int, void** OUTPUT);

int jgrapht_ll_sp_allpairs_get_path_between_vertices(void *, long long int, long long int, void** OUTPUT);

int jgrapht_ii_sp_allpairs_get_singlesource_from_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_sp_allpairs_get_singlesource_from_vertex(void *, long long int, void** OUTPUT);

int jgrapht_ii_sp_exec_astar_get_path_between_vertices(void *, int, int, void *LONG_TO_FPTR, void** OUTPUT);

int jgrapht_ll_sp_exec_astar_get_path_between_vertices(void *, long long int, long long int, void *LONG_TO_FPTR, void** OUTPUT);

int jgrapht_ii_sp_exec_bidirectional_astar_get_path_between_vertices(void *, int, int, void *LONG_TO_FPTR, void** OUTPUT);

int jgrapht_ll_sp_exec_bidirectional_astar_get_path_between_vertices(void *, long long int, long long int, void *LONG_TO_FPTR, void** OUTPUT);

int jgrapht_ii_sp_exec_astar_alt_heuristic_get_path_between_vertices(void *, int, int, void *, void** OUTPUT);

int jgrapht_ll_sp_exec_astar_alt_heuristic_get_path_between_vertices(void *, long long int, long long int, void *, void** OUTPUT);

int jgrapht_ii_sp_exec_bidirectional_astar_alt_heuristic_get_path_between_vertices(void *, int, int, void *, void** OUTPUT);

int jgrapht_ll_sp_exec_bidirectional_astar_alt_heuristic_get_path_between_vertices(void *, long long int, long long int, void *, void** OUTPUT);

int jgrapht_ii_sp_exec_yen_get_k_loopless_paths_between_vertices(void *, int, int, int, void** OUTPUT);

int jgrapht_ll_sp_exec_yen_get_k_loopless_paths_between_vertices(void *, long long int, long long int, int, void** OUTPUT);

int jgrapht_ii_sp_exec_eppstein_get_k_paths_between_vertices(void *, int, int, int, void** OUTPUT);

int jgrapht_ll_sp_exec_eppstein_get_k_paths_between_vertices(void *, long long int, long long int, int, void** OUTPUT);

int jgrapht_ii_sp_exec_delta_stepping_get_path_between_vertices(void *, int, int, double, int, void** OUTPUT);

int jgrapht_ll_sp_exec_delta_stepping_get_path_between_vertices(void *, long long int, long long int, double, int, void** OUTPUT);

int jgrapht_ii_sp_exec_delta_stepping_get_singlesource_from_vertex(void *, int, double, int, void** OUTPUT);

int jgrapht_ll_sp_exec_delta_stepping_get_singlesource_from_vertex(void *, long long int, double, int, void** OUTPUT);
...
int jgrapht_ii_multisp_multiobjectivesinglesource_get_paths_to_vertex(void *, int, void** OUTPUT);

int jgrapht_ll_multisp_multiobjectivesinglesource_get_paths_to_vertex(void *, long long int, void** OUTPUT);

// contraction hierarchy

int jgrapht_ii_sp_manytomany_get_path_between_vertices(void *, int, int, void** OUTPUT);
int jgrapht_ll_sp_manytomany_get_path_between_vertices(void *, long long int, long long int, void** OUTPUT);
...
int jgrapht_ii_sp_exec_contraction_hierarchy_bidirectional_dijkstra_get_path_between_vertices(void *, int, int, double, void** OUTPUT);
int jgrapht_ll_sp_exec_contraction_hierarchy_bidirectional_dijkstra_get_path_between_vertices(void *, long long int, long long int, double, void** OUTPUT);
int jgrapht_xx_sp_exec_transit_node_routing(void *, int, void** OUTPUT);
int jgrapht_ii_sp_exec_transit_node_routing_get_path_between_vertices(void *, int, int, void**  OUTPUT);
int jgrapht_ll_sp_exec_transit_node_routing_get_path_between_vertices(void *, long long int, long long int, void**  OUTPUT);
int jgrapht_ii_sp_exec_transit_node_routing_get_singlesource_from_vertex(void *, int, void**  OUTPUT);
int jgrapht_ll_sp_exec_transit_node_routing_get_singlesource_from_vertex(void *, long long int, void**  OUTPUT);
...
int jgrapht_ii_traverse_create_bfs_from_vertex_vit(void *, int, void** OUTPUT);

int jgrapht_ll_traverse_create_bfs_from_vertex_vit(void *, long long int, void** OUTPUT);
...
int jgrapht_ii_traverse_create_dfs_from_vertex_vit(void *, int, void** OUTPUT);

int jgrapht_ll_traverse_create_dfs_from_vertex_vit(void *, long long int, void** OUTPUT);

int jgrapht_xx_traverse_create_topological_order_vit(void *, void** OUTPUT);

int jgrapht_ii_traverse_create_random_walk_from_vertex_vit(void *, int, void** OUTPUT);

int jgrapht_ll_traverse_create_random_walk_from_vertex_vit(void *, long long int, void** OUTPUT);

int jgrapht_ii_traverse_create_custom_random_walk_from_vertex_vit(void *, int, int, long long int, long long int, void** OUTPUT);

int jgrapht_ll_traverse_create_custom_random_walk_from_vertex_vit(void *, long long int, int, long long int, long long int, void** OUTPUT);
...
int jgrapht_ii_traverse_create_closest_first_from_vertex_vit(void *, int, void** OUTPUT);

int jgrapht_ll_traverse_create_closest_first_from_vertex_vit(void *, long long int, void** OUTPUT);

int jgrapht_ii_traverse_create_custom_closest_first_from_vertex_vit(void *, int, double, void** OUTPUT);

int jgrapht_ll_traverse_create_custom_closest_first_from_vertex_vit(void *, long long int, double, void** OUTPUT);
