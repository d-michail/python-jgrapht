...
class _AttributesGraphGraphPath(_HandleWrapper, GraphPath):
    ...
    def _cache(self):
        ...
        self._edges = list(_AttributesGraphEdgeIterator(eit, self._graph))

    def __repr__(self):
        return "_AttributesGraphGraphPath(%r)" % self._handle


class _AttributesGraphGraphPathIterator(_JGraphTObjectIterator):
    ...
    def __next__(self):
        return _AttributesGraphGraphPath(super().__next__(), self._graph)

    def __repr__(self):
        return "_AttributesGraphGraphPathIterator(%r)" % self._handle


class _AttributesGraphSingleSourcePaths(_HandleWrapper, SingleSourcePaths):
    ...
    def get_path(self, target_vertex):
        ...
        """
        target_vertex = _vertex_attrsg_to_g(self._graph, target_vertex)
        gp = backend.jgrapht_sp_singlesource_get_path_to_vertex(
            self._handle, target_vertex
        )
        return _AttributesGraphGraphPath(gp, self._graph) if gp is not None else None

    def __repr__(self):
        return "_AttributesGraphSingleSourcePaths(%r)" % self._handle


class _AttributesGraphAllPairsPaths(_HandleWrapper, AllPairsPaths):
    ...
    def get_path(self, source_vertex, target_vertex):
        source_vertex = _vertex_attrsg_to_g(self._graph, source_vertex)
        target_vertex = _vertex_attrsg_to_g(self._graph, target_vertex)
    ...
    def get_paths_from(self, source_vertex):
        ...
        return _AttributesGraphSingleSourcePaths(singlesource, self._graph, source_vertex)

    def __repr__(self):
        return "_AttributesGraphAllPairsPaths(%r)" % self._handle


class _AttributesGraphMultiObjectiveSingleSourcePaths(_HandleWrapper, MultiObjectiveSingleSourcePaths):
    ...
    def get_paths(self, target_vertex):
        ...
        return _AttributesGraphGraphPathIterator(handle=gp_it, graph=self._graph)

    def __repr__(self):
        return "_AttributesGraphMultiObjectiveSingleSourcePaths(%r)" % self._handle
