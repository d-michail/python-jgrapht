...
def _get_hash_fptr_wrapper():
    ...
    if __hash_fptr_wrapper is None:
        ...
        __hash_fptr_wrapper = _refcount._CallbackWrapper(hash, hash_type)
...
def _get_equals_fptr_wrapper():
    ...
    if __equals_fptr_wrapper is None:
        ...
        __equals_fptr_wrapper = _refcount._CallbackWrapper(_equals, equals_type)
...
class _EqualsHashWrapper(_HandleWrapper):
    ...
    def __init__(self):
        self._hash_lookup_fptr_wrapper = _refcount._CallbackWrapper(
            _hash_lookup, ctypes.CFUNCTYPE(ctypes.c_long, ctypes.py_object)
        )
        self._equals_lookup_fptr_wrapper = _refcount._CallbackWrapper(
