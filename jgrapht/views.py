...
from ._internals._attrsg import (
    _AttributesGraph,
    is_attrs_graph,
    as_unweighted_attrs_graph as _as_unweighted_attrs_graph,
    as_undirected_attrs_graph as _as_undirected_attrs_graph,
    as_unmodifiable_attrs_graph as _as_unmodifiable_attrs_graph,
    as_edgereversed_attrs_graph as _as_edgereversed_attrs_graph,
    as_weighted_attrs_graph as _as_weighted_attrs_graph,
    as_masked_subgraph_attrs_graph as _as_masked_subgraph_attrs_graph,
)
...
def as_listenable(graph):
    ...
    """
    if isinstance(graph, ListenableGraph) or is_attrs_graph(graph):
        return graph
