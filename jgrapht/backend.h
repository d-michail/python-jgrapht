...
int jgrapht_export_string_gml(void *, int, void *, void *, void **);

int jgrapht_export_file_json(void *, char*, void *, void *);

int jgrapht_export_string_json(void *, void *, void *, void **);

int jgrapht_export_file_lemon(void *, char*, int, int);

int jgrapht_export_string_lemon(void *, int, int, void **);

int jgrapht_export_file_csv(void *, char*, csv_format_t, int, int, int);

int jgrapht_export_string_csv(void *, csv_format_t, int, int, int, void **);

int jgrapht_export_file_gexf(void *, char*, void *, void *, void *, int, int, int, int);

int jgrapht_export_string_gexf(void *, void *, void *, void *, int, int, int, int, void **);

int jgrapht_export_file_dot(void *, char*, void *, void *);

int jgrapht_export_string_dot(void *, void *, void *, void **);
...
int jgrapht_export_string_graphml(void *, void *, void *, void *, int, int, int, void**);
...
int jgrapht_gomoryhu_exec_gusfield(void *, void**);

int jgrapht_gomoryhu_min_st_cut(void *, int, int, double*, void**);

int jgrapht_gomoryhu_min_cut(void *, double*, void**);

int jgrapht_gomoryhu_tree(void *, void**);
