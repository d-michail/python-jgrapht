...
int jgrapht_xxl_graph_attrs_get(void *, char*, long long*);
int jgrapht_ixl_graph_attrs_vertex_get(void *, int, char*, long long*);
int jgrapht_lxl_graph_attrs_vertex_get(void *, long long int, char*, long long*);
int jgrapht_rxl_graph_attrs_vertex_get(void *, void *, char*, long long*);
int jgrapht_xil_graph_attrs_edge_get(void *, int, char*, long long*);
int jgrapht_xll_graph_attrs_edge_get(void *, long long int, char*, long long*);
int jgrapht_xll_graph_attrs_edge_get(void *, long long int, char*, long long*);
int jgrapht_xrl_graph_attrs_edge_get(void *, void *, char*, long long*);
int jgraphtl_xxl_graph_attrs_put(void *, char*, long long int);
int jgrapht_ixl_graph_attrs_vertex_put(void *, int, char*, long long int);
int jgrapht_lxl_graph_attrs_vertex_put(void *, long long int, char*, long long int);
int jgrapht_rxl_graph_attrs_vertex_put(void *, void *, char*, long long int);
int jgrapht_xil_graph_attrs_edge_put(void *, int, char*, long long int);
int jgrapht_xll_graph_attrs_edge_put(void *, long long int, char*, long long int);
int jgrapht_xrl_graph_attrs_edge_put(void *, void *, char*, long long int);
int jgrapht_xxx_graph_attrs_remove(void *, char*);
int jgrapht_ixx_graph_attrs_vertex_remove(void *, int, char*);
int jgrapht_lxx_graph_attrs_vertex_remove(void *, long long int, char*);
int jgrapht_rxx_graph_attrs_vertex_remove(void *, void *, char*);
int jgrapht_xix_graph_attrs_edge_remove(void *, int, char*);
int jgrapht_xlx_graph_attrs_edge_remove(void *, long long int, char*);
int jgrapht_xrx_graph_attrs_edge_remove(void *, void *, char*);
int jgrapht_xxx_graph_attrs_contains(void *, char*, int*);
int jgrapht_ixx_graph_attrs_vertex_contains(void *, int, char*, int*);
int jgrapht_lxx_graph_attrs_vertex_contains(void *, long long int, char*, int*);
int jgrapht_rxx_graph_attrs_vertex_contains(void *, void *, char*, int*);
int jgrapht_xix_graph_attrs_edge_contains(void *, int, char*, int*);
int jgrapht_xlx_graph_attrs_edge_contains(void *, long long int, char*, int*);
int jgrapht_xrx_graph_attrs_edge_contains(void *, void *, char*, int*);
int jgrapht_xxx_graph_attrs_keys_iterator(void *, void**);
int jgrapht_ixx_graph_attrs_vertex_keys_iterator(void *, int, void**);
int jgrapht_lxx_graph_attrs_vertex_keys_iterator(void *, long long int, void**);
int jgrapht_rxx_graph_attrs_vertex_keys_iterator(void *, void *, void**);
int jgrapht_xix_graph_attrs_edge_keys_iterator(void *, int, void**);
int jgrapht_xlx_graph_attrs_edge_keys_iterator(void *, long long int, void**);
int jgrapht_xrx_graph_attrs_edge_keys_iterator(void *, void *, void**);
int jgrapht_xxx_graph_attrs_size(void *, int*);
int jgrapht_ixx_graph_attrs_vertex_size(void *, int, int*);
int jgrapht_lxx_graph_attrs_vertex_size(void *, long long int, int*);
int jgrapht_rxx_graph_attrs_vertex_size(void *, void *, int*);
int jgrapht_xix_graph_attrs_edge_size(void *, int, int*);
int jgrapht_xlx_graph_attrs_edge_size(void *, long long int, int*);
int jgrapht_xrx_graph_attrs_edge_size(void *, void *, int*);
