...
int jgrapht_R_list_add(void *, void *, int*);
...
int jgrapht_map_int_ref_put_direct(void *, int, void *, void *);
...
int jgrapht_map_long_ref_put_direct(void *, long long int, void *, void *);
...
int jgrapht_map_int_obj_get(void *, int, void**);
int jgrapht_map_int_ref_get_direct(void *, int, void**);
...
int jgrapht_map_long_obj_get(void *, long long int, void**);
int jgrapht_map_long_ref_get_direct(void *, long long int, void**);
...
int jgrapht_map_int_obj_remove(void *, int, void**);
int jgrapht_map_int_ref_remove_direct(void *, int, void**);
...
int jgrapht_map_long_obj_remove(void *, long long int, void**);
int jgrapht_map_long_ref_remove_direct(void *, long long int, void**);
...
int jgrapht_R_set_add(void *, void *, int*);
int jgrapht_r_set_add(void *, void *LONG_TO_PTR, void *, int*);
...
int jgrapht_R_set_remove(void *, void *, int*);
int jgrapht_r_set_remove(void *, void *LONG_TO_PTR, void *, int*);
...
int jgrapht_R_set_contains(void *, void *, int*);
int jgrapht_r_set_contains(void *, void *LONG_TO_PTR, void*, int*);
